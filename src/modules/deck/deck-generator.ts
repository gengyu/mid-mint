...
import { assertContentBrief, assertDeckPlan, assertParsedSource } from "@/modules/domain/validation";
import type { ContentBrief, DeckPageType, DeckPlan, DeckSlide, ParsedSource } from "@/modules/domain/types";
import {
  type StageRunResult,
